...
const submit = () => {
    form.post(route('performance-agreements.store'), {
        onSuccess: () => {
            router.visit(route('performance-agreements.index'));
        },
        onError: (errors) => {
...
<template>
    ...
    <Head title="Buat Perjanjian Kinerja" />
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <form @submit.prevent="submit" class="p-6">
                        ...
                        <div class="flex justify-end space-x-4">
                            <SecondaryButton type="button" @click="router.visit(route('performance-agreements.index'))">
                                Batal
                            </SecondaryButton>
