...
class MonthlyAssessmentSubmitted extends Mailable implements ShouldQueue
{
    ...
    public function envelope(): Envelope
    {
        ...
        return new Envelope(
            subject: "Penilaian Bulanan {$monthName} {$this->assessment->year} Telah Diajukan - APP PKP",
        );
    }
    ...
    {
        return new Content(
            view: 'emails.monthly-assessment-submitted',
            with: [
